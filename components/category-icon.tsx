// Kategori ortak sözlüğü — ikon, isim ve kapak gradyanı tek yerde.
...
// Kapak görseli olmayan kartlar için kategori gradyanı [başlangıç, bitiş]
export const CATEGORY_GRADIENT: Record<string, [string, string]> = {
  kitap: ['#C2501F', '#E07B39'],
  'doğa': ['#2F6B4F', '#6FA88B'],
  'müzik': ['#7B4B94', '#B58CC9'],
  lezzet: ['#B5641F', '#E39B4E'],
  dil: ['#2A5B8F', '#6C9CCB'],
  spor: ['#1F6E52', '#4C9A78'],
  sanat: ['#A83A6E', '#D077A2'],
  oyun: ['#B04330', '#D97A63'],
  tech: ['#2B3A55', '#5B7BB4'],
  sinema: ['#544A86', '#8A7DC0'],
  'fotoğraf': ['#23697A', '#5AA3B5'],
  'gönüllülük': ['#A34A22', '#CE7B4E'],
  kariyer: ['#46603A', '#7D9A6C'],
  sosyal: ['#A8354F', '#D06B84'],
  default: ['#8A94A2', '#B9C0CB'],
}

export function categoryGradient(slug: string | null | undefined): string {
  const [from, to] = CATEGORY_GRADIENT[slug ?? 'default'] ?? CATEGORY_GRADIENT.default
