    ...
    <section className="cc">
      ...
      <style>{`
        .cc {
          ...
          background-image: radial-gradient(rgba(15, 46, 92, .16) 1px, transparent 1px);
        ...
        .cc-btn {
          ...
          box-shadow: 0 14px 30px -14px rgba(12, 27, 142, .8);
